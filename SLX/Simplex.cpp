...
struct SIMPLEX {
	...
	/*-----------------------------------------------------------------------------------------------
		...
		A[1 + 3][1] = a11; A[1 + 3][2] = a12; A[1 + 3][3] = a13; A[1 + 3][4] = a14; b[1 + 3] = b1;
		A[2 + 3][1] = a21; A[2 + 3][2] = a22; A[2 + 3][3] = a23; A[2 + 3][4] = a24; b[2 + 3] = b1;
		A[3 + 3][1] = a31; A[3 + 3][2] = a32; A[3 + 3][3] = a33; A[3 + 3][4] = a34; b[3 + 3] = b1;
	------------------------------------------------------------------------------------------------*/
